...
`H-eries` 의 모든 소설은 **비상업적 크로스팬픽** 이다. 본문에 등장하는 캐릭터·세계관 중 다수는 다른 작가의 웹툰·소설에서 차용하며, 원작 권리는 각 원저작자에게 귀속된다. 본 저장소의 어떤 콘텐츠도 상업적 사용을 허락하지 않는다. 모든 산출물 .md 첫 줄에 다음 HTML 주석 1줄을 부착한다:
