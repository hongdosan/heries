...
6. **메타 정확성** — 본 작품은 작가 hongdosan 의 *100% 오리지널 창작*. **외부 IP 차용 ZERO**. 본문 사실은 lorekeeper 카드 SSOT + worldsmith 세계관 SSOT 와 일치해야 한다. 작가 분기·미발현 떡밥은 카드의 *H-eries 분기 절* 에서만 다룬다.
...
- [ ] 본문 사실이 lorekeeper 카드 SSOT 와 일치 (특히 무공명·인격 호칭·능력 조건)
