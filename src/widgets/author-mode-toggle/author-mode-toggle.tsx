...
const EyeOffIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
       strokeLinecap="round" strokeLinejoin="round" aria-hidden>
    <path
      d="M17.94 17.94A10.07 10.07 0 0 1 12 19c-7 0-10-7-10-7a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 10 7 10 7a17.85 17.85 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/>
...
export function AuthorModeToggle() {
  ...
  return (
    <>
      ...
      {/* native dialog backdrop click 닫기 = W3C 표준 패턴. Escape 키는 dialog 자체 처리.
      ...
      >
        <div
          className="bg-surface border border-rule rounded-md p-5 flex flex-col gap-3 text-fg shadow-soft">
          {isAuthor ? (
            <>
            ...
            <form onSubmit={onSubmit} noValidate className="flex flex-col gap-3">
              ...
              <p
                className="m-0 p-3 px-4 border-l-[3px] border-l-warn-rule bg-warn-bg text-warn-fg text-sm rounded-r-md leading-[1.6]">
              ...
              <label htmlFor="author-mode-key"
                     className="text-xs font-semibold uppercase tracking-[0.08em] text-fg-3 mt-1">작가
                키</label>
